    ...
    <body>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<td><a href=";
                echo "'http://localhost/arpitha-training/classes/update1.php?emp_id=" . $row['emp_id'] . "'";
                echo "'>edit</a></td>";
            ...
            echo "</tbody>";
            echo "</table>";
            echo "<a href='http://localhost/arpitha-training/classes/insert.php'>Insert Record</a>";
        } else {
